...
!! initialize daily variables
      ...
      rtevp = 0.
      rttime = 0.
      !Determine if initializing the swat reach loss variable is already performed by SWAT-MODFLOW linkage !tcw
      initializeRCHloss = .true. !tcw
      call OnRouteInitialize%fire() !tcw
      if(initializeRCHloss)then !tcw
        rttlc = 0. !tcw
      end if !tcw
      rtwtr = 0.
      sdti = 0.
